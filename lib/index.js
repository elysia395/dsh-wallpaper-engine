...
import { resolveSceneTexPath, pkgSceneAccess, dirSceneAccess, parseTex, decodeTex, setGlobalAssetsRoots, readGlobalAsset, extractTexVideoMp4 } from './pkg-extract.js';
...
function sanitizeSettings(raw) {
  ...
  return {
    ...
    // Coexistence v1 (mirror of src/client.js sanitizeSettings).
    appearanceOwner: o.appearanceOwner === 'skin' ? 'skin' : 'plugin',
