  ...
  disposers.push(webServer.register({
    ...
    handler: (req, res) => {
      ...
      (async () => {
        ...
        // served stale from disk. sf14 = alignment 位置修复 (骨骼头变体/蒙皮兼容/顶点
        // sanity/systemfont/filmgrain _sat3) + MDLE 段解析.
        const key = 'sf14_' + Buffer.from(abs, 'utf8').toString('base64url') + '_' + Math.round(mtime);
