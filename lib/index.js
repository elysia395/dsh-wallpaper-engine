  ...
  disposers.push(webServer.register({
    ...
    handler: (req, res) => {
      ...
      (async () => {
        ...
        // served stale from disk. sf27 = 官方视图平移 T(-eye) (前景经 view,
        // 背景 0x1100 跳过) — wallpaper64 逆向 0x1401EC720/0x1160 view 缓存.
        const key = 'sf27_' + Buffer.from(abs, 'utf8').toString('base64url') + '_' + Math.round(mtime);
