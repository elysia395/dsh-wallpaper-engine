// A4: 官方 common_blending.h 原文 (~/Pictures/WallpaperEngine/assets/shaders/
// common_blending.h, 2026-09 逐条对照替换重建版)。与官方唯一偏离: 头部补
// CAST3/BLENDMODE 守卫 — 官方引擎将 CAST3 作为内置注入 (assets 全树无
// #define CAST3), 我们的 include 白名单展开无全局注入; 只 include
// common_blending.h 的 shader (如 passthroughblend.frag) 需要它。
// 对照结论 (CPU math.js applyBlending 已同步): mode 5/10 官方无 opacity
// mix (直接 return min/max); mode 4/20 官方即同为 BlendSubstract。
#ifndef CAST3
