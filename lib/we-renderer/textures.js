...
// LZ4 解压整个容器, 同 buffer 重复解析是纯浪费。注: loadTexImage 内 parseTex
// 与 decodeTex (pkg-extract 内部再跑 parseTexInternal) 的双解析, 需
// pkg-extract.js 的 decodeTex 接收预解析 info 才能合并 — 该文件不在本轮
// 修复文件清单内, 维持现状 (见 perf-audit review2 P1-11)
