...
export class SceneRenderer {
  ...
  renderImage(o, t) {
    ...
    // 官方渲染链 (wallpaper64 逆向): image 对象 (普通图像) 不经过视图矩阵 —
    // 直接 ortho(0,w,0,h) 映射场景坐标 (0x1401e8ecb 路径, 无 origin×视图矩阵);
    // 视图矩阵 (-eye) 仅应用于 puppet (骨骼模型, 0x1401e8b60 路径)。
    // lwe 的 ortho*T(eye)*lookAt 是 lwe 补丁, 官方 image 无视图平移。
