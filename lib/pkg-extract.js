...
function tryCompositeSceneLayers(scene, access, label) {
  ...
  // WE clears the scene with the author's scheme color; keep it as the frame
  // background so gaps between panels match the desktop render.
  ...
  const scheme = parseSceneVec3(schemeRaw, null);
  if (scheme) {
