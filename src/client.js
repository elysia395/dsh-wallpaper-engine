...
// onLoad is required: card CSS starts img/video at opacity:0 and fades in on load.
const cardThumb = (w) => w.preview
  ? React.createElement("img", { src: w.preview, alt: w.title, loading: "lazy", onError: (e) => { e.target.style.display = "none"; }, onLoad: (e) => { e.target.style.opacity = "1"; } })
  : (w.type === "image"
      ? React.createElement("img", { src: w.media, alt: w.title, loading: "lazy", onError: (e) => { e.target.style.display = "none"; }, onLoad: (e) => { e.target.style.opacity = "1"; } })
      : (w.type === "video"
          ? React.createElement("video", { src: w.media, preload: "metadata", muted: true, playsInline: true, onError: (e) => { e.target.style.display = "none"; }, onLoadedData: (e) => { e.target.style.opacity = "1"; } })
