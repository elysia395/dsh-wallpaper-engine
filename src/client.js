...
// This round: the adjustment pages (settings section + the rope-dock 壁纸仓库
// drawer) were reorganised into six top-level tabs (壁纸/外观/字体/吉祥物/效果/
// 高级) with a unified control refresh — plus a new Desktop tip: DSH Desktop
// users should pick 增强模式 and enable 玻璃材质 in the desktop settings for
// the best borderless fullscreen immersive result. The dismissal version is
...
function UpdateNotice() {
  ...
  return React.createElement("div", { className: "we-update-notice", role: "alert" },
    React.createElement("div", { className: "we-update-notice__title" }, "🎨 全新改版：调节页面六大页签，组件质感全面升级"),
    React.createElement("div", { className: "we-update-notice__body" },
      React.createElement("p",
        null,
        "设置页与「壁纸仓库」抽屉的调节项按用途重组为六大页签——壁纸 / 外观 / 字体 / 吉祥物 / 效果 / 高级，每页只保留相关控件，不用再在一列三十项里翻找；长说明移入悬停提示，吉祥物形态改为卡片立绘实时预览，开关 / 滑条 / 色板 / 按钮视觉同步升级。功能一项不少，都在对应的页签里。"),
      React.createElement("p",
        null,
