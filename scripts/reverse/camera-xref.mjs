// orthogonalprojection (0x4890c0) / eye (0x48e59c) / camera (0x48e4d0) 的 xref
...
for (const [n, hits] of Object.entries(results)) {
  ...
  hits.slice(0, 8).forEach(h => console.log(`  0x${h.va.toString(16)}`));
}
